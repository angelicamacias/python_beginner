...
JOIN watche ON movies.id = watched.movie_id 
JOIN users ON users.username = watched.user_username
WHERE users.uername = ?;"""
INSERT_WATCHED_MOVIE = "INSERT INTO watched (user_username, movie_id) VALUES (?, ?)"
SET_MOVIE_WATCHED = "UPDATE movies SET watched = 1 WHERE = ?;"
...
connection = sqlite3.connect('C:/Users/angel/python/python_beginner/BasicPython/Python  y SQL/movies/data.db')
...
def get_movies(upcoming=False):
    with connection:
        ...
        if upcoming:
            ...
            cursor.execute(SELECT_ALL_MOVIES, (today_timestamp))
        else:
